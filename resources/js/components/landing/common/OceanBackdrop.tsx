export function OceanBackdrop() {
  return (
    <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden [contain:paint]">
      <div className="absolute inset-0 gradient-ocean" />
      <div className="absolute -left-40 top-20 h-[520px] w-[520px] rounded-full bg-[oklch(0.78_0.14_195/0.25)] blur-2xl transform-gpu" />
      <div className="absolute -right-32 top-40 h-[460px] w-[460px] rounded-full bg-[oklch(0.55_0.14_235/0.25)] blur-2xl transform-gpu" />
